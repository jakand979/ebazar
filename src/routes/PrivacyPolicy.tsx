...
<Navbar />
<Categories />
<div className="mx-16 mt-16 text-center">
...
Janusz Kowalski Marynarkowa 13/13 00-240 Poznań
</li>
<li>
3. Adres kontaktowy poczty elektronicznej operatora:
e-bazar.official@gmail.com
</li>
<li>
...
<ul>
<li>
&emsp;a. Przygotowanie, pakowanie, wysyłka towarów
</li>
<li>&emsp;b. Realizacja zamówionych usług
</li>
<li>&emsp;c. Prezentacja oferty lub informacji
</li>
</ul>
<li>
6. Serwis realizuje funkcje pozyskiwania informacji o użytkownikach i
ich zachowaniu w następujący sposób:
<ol>
<li>&emsp;a. Poprzez dobrowolnie wprowadzone w formularzach dane, które
zostają wprowadzone do systemów Operatora.
</li>
<li>&emsp;b. Poprzez zapisywanie w urządzeniach końcowych plików cookie
(tzw. „ciasteczka”).
</li>
</ol>
</li>
...
<li>
4. W serwisie jest stosowana autentykacja dwuskładnikowa, co stanowi
...
<ul>
<li>&emsp;a. zasoby określone identyfikatorem URL (adresy żądanych
zasobów – stron, plików),
</li>
<li>&emsp;b. czas nadejścia zapytania,
</li>
<li>&emsp;c. czas wysłania odpowiedzi,
</li>
<li>&emsp;d. nazwę stacji klienta – identyfikacja realizowana przez
protokół HTTP,
</li>
<li>&emsp;e. informacje o błędach jakie nastąpiły przy realizacji
transakcji HTTP,
</li>
<li>&emsp;f. adres URL strony poprzednio odwiedzanej przez użytkownika
(referer link) – w przypadku gdy przejście do Serwisu
nastąpiło przez odnośnik,
</li>
<li>&emsp;g. informacje o przeglądarce użytkownika,
</li>
<li>&emsp;h. informacje o adresie IP,
</li>
<li>&emsp;i. informacje diagnostyczne związane z procesem samodzielnego
zamawiania usług poprzez rejestratory na stronie,
</li>
<li>&emsp;j. informacje związane z obsługą poczty elektronicznej
...
<li>&emsp;b. operatorzy pocztowi
</li>
<li>&emsp;c. operatorzy płatności
</li>
<li>&emsp;d. operatorzy rozwiązania typu chat online
</li>
<li>&emsp;e. upoważnieni pracownicy i współpracownicy, którzy korzystają
z danych w celu realizacji celu działania strony
</li>
<li>&emsp;f. firmy, świadczące usługi marketingu na rzecz Administratora
</li>
</ul>
</li>
<li>
...
<ul>
<li>&emsp;a. dostępu do danych osobowych Ciebie dotyczących,
</li>
<li>&emsp;b. ich sprostowania,
</li>
<li>&emsp;c. usunięcia,
</li>
<li>&emsp;d. ograniczenia przetwarzania,
</li>
<li>&emsp;e. oraz przenoszenia danych.
</li>
</ul>
</li>
<li>
...
<a href="https://www.google.com/ads/preferences/" className="hover:text-orange-600">&nbsp;https://www.google.com/ads/preferences/</a>
</li>
</ol>
<h2 className="mt-4 font-bold text-4xl">
...
<ol>
<li>
&emsp;a. utrzymanie sesji użytkownika Serwisu (po zalogowaniu),
dzięki której użytkownik nie musi na każdej podstronie
Serwisu ponownie wpisywać loginu i hasła;
</li>
<li>
&emsp;b. realizacji celów określonych powyżej w części "Istotne
...
<li>
<a
href="https://support.microsoft.com/pl-pl/help/10607/microsoft-edge-view-delete-browser-history" className="hover:text-orange-600"
>
&emsp;a. Edge
</a>
</li>
<li>
<a
href="https://support.microsoft.com/pl-pl/help/278835/how-to-delete-cookie-files-in-internet-explorer" className="hover:text-orange-600"
>
&emsp;b. Internet Explorer
</a>
</li>
<li>
<a
href="http://support.google.com/chrome/bin/answer.py?hl=pl&amp;answer=95647" className="hover:text-orange-600"
>
&emsp;c. Chrome
</a>
</li>
<li>
<a href="http://support.apple.com/kb/PH5042" className="hover:text-orange-600">d. Safari</a>
</li>
<li>
<a
href="http://support.mozilla.org/pl/kb/W%C5%82%C4%85czanie%20i%20wy%C5%82%C4%85czanie%20obs%C5%82ugi%20ciasteczek" className="hover:text-orange-600"
>
&emsp;e. Firefox
</a>
</li>
<li>
<a
href="http://help.opera.com/Windows/12.10/pl/cookies.html" className="hover:text-orange-600"
>
&emsp;f. Opera
</a>
</li>
...
<li>
<a
href="http://support.apple.com/kb/HT1677?viewlocale=pl_PL" className="hover:text-orange-600"
>
&emsp;b. Safari (iOS)
</a>
</li>
<li>
<a
href="http://www.windowsphone.com/pl-pl/how-to/wp7/web/changing-privacy-and-other-browser-settings" className="hover:text-orange-600"
>
&emsp;c. Windows Phone
</a>
</li>
</ul>
</li>
